<template>
  ...
  >
    <GameStateStart v-if="uiState === 'start'">
      <h1>Which hooman you wanna be?</h1>
      <p
...
<script>
  ...
  export default {
    ...
    methods: {
      pickCharacter() {
        this.$store.commit('setCharacter', this.characterinput);
        this.$store.commit('setUiState', 'characterChosen');
      },
...
<!--main styles that apply throughout the app-->
<style>
  * {
    text-align: left;
  }
